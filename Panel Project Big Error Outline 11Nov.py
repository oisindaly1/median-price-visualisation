...
def draw_outline(ax3d, counties, coords):
    ...
    try:
        outline = Line3DCollection(tuple(final_lines), colors = 'black', linewidth = 1.5, alpha = 0.9, zorder = 5)
        ax3d.add_collection3d(outline)      
    except Exception as e:
        print("Outline didnt output", e)

draw_outline(ax3d, counties, coords)         
